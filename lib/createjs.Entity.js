...
createjs.Entity = (function() {
	...
	var entityClass = Class.extend({
		...
		coord: function() {
			return new createjs.Coordinates(this.displayObject.localToLocal(this.displayObject.regX, this.displayObject.regY, this.world.displayObject));
		},
		...
		moveTo: function(toX, toY) {
			...
			// (where up = 0, down = 1)
			dx = toX - this.displayObject.x;
			dy = toY - this.displayObject.y;
